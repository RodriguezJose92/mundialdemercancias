    ...
    /** Create button only 3D  ✔️*/
        ...
        <?xml version="1.0" encoding="UTF-8"?>
            <svg id="img3DBtn" class="btnMudi3D" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 360">
                ...
                <circle class="cls-2mudimudi" cx="170" cy="178.45" r="150.5"/>
                <g id="vert3b-thumb">
    ...
    createModal(){
            ...
            <div class="iframeMudi3D">
                ...
                <div class="containerBtnsActions">
                    ...
                    <defs>
                        ...
                        .cls-2mudimudi_modal{font-family:FrutigerBold, Frutiger;font-size:19.04px;fill:white}
                    ...
                    <rect class="cls-1_modal" x="9.52" y="9" width="292.07" height="87" rx="40" ry="40"/>
                        ...
                        <text class="cls-2mudimudi_modal" transform="translate(103.37 58.47)"><tspan x="0" y="0">VER EN TU ESPACIO</tspan></text>
                    </svg>
                    ...
                    <div id="containerQR" class="containerQRMudi" style="background-color:${this.color}">
                        ...
                        <div class="containerText">
                            ...
                            <div class="titleContainer">
                                ...
                                <p class="textInfoMudi">Apunta el teléfono a una superficie plana.</p>
                            </div>
        ...
        function changeStyleBtnAR(flagAR,color){
            ...
            ? (
                ...
                document.body.querySelector('.cls-2mudimudi_modal').style.fill="white"
            ) 
            : (
                document.body.querySelector('.cls-1_modal').style.fill="white",
                icon.forEach((icon)=>icon.style.fill=color),
                document.body.querySelector('.cls-2mudimudi_modal').style.fill=color
            )
        };
